    ...
    ui(new Ui::MainWindow)
{
    ...
    m_chatClient = new CharClient(this);

    connect(m_chatClient, &CharClient::connected, this, &MainWindow::connectedToServer);
//    connect(m_chatClient, &CharClient::messageReceived, this, &MainWindow::messageReceived);
    connect(m_chatClient, &CharClient::jsonReceived, this, &MainWindow::jsonReceived);
